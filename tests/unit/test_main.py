...
class TestAPI(unittest.TestCase):
    def test_hello(self):
        ...
        self.assertEquals(response.json(), {"message": "Hello World!"})
    ...
    def test_add(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(response.json(), {"result": 15})
    ...
    def test_add_with_string(self):
        ...
        self.assertEquals(response.json()["detail"][0]["msg"],
    ...
    def test_join_words(self):
        ...
        self.assertEquals(response.status_code, 200)
        self.assertEquals(response.json(), {"result": "hello-world"})
